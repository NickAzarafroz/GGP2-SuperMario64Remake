...
#include "Scenes/SuperMario64/MainMenuScene.h"
#endif
...
void MainGame::OnGamePreparing(GameContext& gameContext)
{
	...
	//gameContext.windowTitle = L"GP2 - Milestone 1 (2023) | (2DAE07) Azarafroz Nick";
	//gameContext.windowTitle = L"GP2 - Milestone 2 (2023) | (2DAE07) Azarafroz Nick";
	gameContext.windowTitle = L"GP2 - Exam Project (2023) | (2DAE07) Azarafroz Nick";
}
...
void MainGame::Initialize()
{
	...
	SceneManager::Get()->AddGameScene(new Mario64Scene());
#endif
